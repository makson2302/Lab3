"""Программа для учёта измерений температуры с графическим интерфейсом, логированием ошибок и редактированием."""
...
class EditDialog(simpledialog.Dialog):
    """Диалоговое окно для редактирования измерения."""
    ...
    def body(self, master):
        """Создаёт поля ввода с текущими значениями."""
        ...
        return self.date_entry  # начальный фокус

    def apply(self):
        """Применяет изменения при нажатии OK."""
        try:
...
class Application:
    ...
    def edit_measurement(self) -> None:
        """Редактирует выделенное измерение."""
